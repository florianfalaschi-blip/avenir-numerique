...
export const defaultBrochuresParams: BrochuresParams = {
  machines_impression: [
    ...
    {
      id: 'canon',
      nom: 'Canon (imagePRESS)',
      techno: 'numerique',
      format_max_mm: {
        largeur: 330,
        hauteur: 488,
      },
      vitesse_feuilles_h: 5400,
      taux_horaire_ht: 9,
      cout_calage_ht: 0,
      recto_verso_calage_unique: true,
      gaches_pct: 3,
      operateur_taux_horaire_ht: 28.67,
      actif: true,
    },
  ],
  machines_faconnage: [
    {
      ...
      taux_horaire_ht: 1,
      operateur_taux_horaire_ht: 28.67,
      cout_consommables_unitaire_ht: 0.02,
    },
    {
      id: 'piqueuse_horyzon',
      nom: 'Piqueuse Horyzon (auto)',
      type: 'agrafe',
      vitesse_h: 3000,
      taux_horaire_ht: 8,
      operateur_taux_horaire_ht: 28.67,
    ...
    {
      id: 'bq_470',
      nom: 'BQ 470 (dos carré collé)',
      type: 'dos_carre_colle',
      vitesse_h: 600,
      taux_horaire_ht: 10,
      operateur_taux_horaire_ht: 28.67,
      cout_consommables_unitaire_ht: 0.15,
    },
    {
      id: 'dos_carre_pique',
      nom: 'Dos carré piqué',
    ...
    },
    {
      ...
      taux_horaire_ht: 1,
      operateur_taux_horaire_ht: 28.67,
      cout_consommables_unitaire_ht: 0.5,
    },
    {
      id: 'plieuse',
      nom: 'Plieuse',
