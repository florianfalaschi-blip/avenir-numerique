...
/**
 * Paramètres par défaut Roll-up (valeurs estimées).
 *
 * Sert de fallback initial pour `useSettings('rollup', ...)`.
 * Une fois Florian a saisi ses valeurs réelles, elles écrasent ces
 * defaults via localStorage (Phase 3a) puis Supabase (Phase 3b).
 */
export const defaultRollupParams: RollupParams = {
  baches: [
